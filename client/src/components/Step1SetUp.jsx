...
function Step1SetUp({ onStart }) {
  ...
  const handleStart = async () => {
    ...
    if (!trimmedRole || !trimmedExperience || !trimmedMode) {
      console.error("Role, experience, and mode are required.");
      return;
    }
    ...
    try {
      ...
      console.error("Generate questions failed:", error.response?.status, message);
      ...
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        ...
        >
          ...
          <div className="space-y-6">
                  ...
                  {projects.length > 0 && (
                    ...
                    <p className='font-medium text-gray-700 mb-1'>
                      Projects:</p>
                         ...
                         <ul className='list-desc list-inside text-gray-600 space-y-1'>
                          {projects.map((p, i) => (
                            <li key={i}>{p}</li>
                          ))}
                         </ul>
            ...
            {serverError && (
              <p className="text-sm text-red-600 mb-3">{serverError}</p>
            )}
